...
'''
	Summary:
		...
		Open the Python interactive console and do similarly as below:
			...
			sequencer_fbx_examples.export_fbx("/Game/Maps/FbxTest","/Game/FbxTest", "/Game/FbxTest_Master", "D:\\FBX_Test.fbx")
...
def export_fbx(map_asset_path, sequencer_asset_path, root_sequencer_asset_path, output_file):
	...
	# Export
	export_fbx_params = unreal.SequencerExportFBXParams(world, sequence, root_sequence, bindings, master_tracks, export_options, output_file)
