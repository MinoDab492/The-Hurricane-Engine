...
class CascadeWorldOffsetConverter(ModuleConverterInterface):
    ...
    def convert(cls, args):
        ...
        if emitter.find_renderer("RibbonRenderer") is not None:
            ...
            script_asset = ue.AssetData(Paths.script_initialize_ribbon)
            script_version = [1, 1]
        else:
            script_name = "InitializeParticle"
            script_asset = ue.AssetData(Paths.script_initialize_particle)
            script_version = [1, 0]
        ...
        if distribute_over_n_points != 0.0 and distribute_over_n_points != 1.0:
            ...
            script_asset = ue.AssetData(Paths.di_divide_float)
        ...
        initialize_script.set_parameter("Position Offset", position_input, True, True)
