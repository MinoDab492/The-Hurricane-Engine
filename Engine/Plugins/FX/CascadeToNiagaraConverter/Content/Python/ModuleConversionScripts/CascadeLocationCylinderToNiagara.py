...
class CascadeCylinderLocationConverter(ModuleConverterInterface):
    ...
    def convert(cls, args):
        ...
        script_asset = ue.AssetData(Paths.script_location_shape)
        ...
        if b_velocity:
            ...
            script_asset = ue.AssetData(Paths.script_add_velocity)
            ...
            if b_radial_velocity:
                ...
                script_asset = ue.AssetData(Paths.di_multiply_vector)
                script_args = ue.CreateScriptContextArgs(script_asset)
            ...
            if c2nUtils.distribution_always_equals(velocity_scale_distribution, 0.0) is False:
                ...
                script_asset = ue.AssetData(Paths.di_multiply_vector_by_float)
                script_args = ue.CreateScriptContextArgs(script_asset)
