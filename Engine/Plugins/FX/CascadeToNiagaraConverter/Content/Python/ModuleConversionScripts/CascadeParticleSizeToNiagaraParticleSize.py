...
class CascadeParticleSizeConverter(ModuleConverterInterface):
    ...
    def __convert_ribbon_size(cls, cascade_module, emitter_context):
        ...
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.script_initialize_ribbon), [1, 1])
        ...
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_multiply_float), [1, 0])
