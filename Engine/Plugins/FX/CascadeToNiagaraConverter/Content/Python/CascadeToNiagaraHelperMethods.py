...
def create_script_input_for_distribution(
    ...
    def __convert_distribution_locked_axes(
        ...
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_split_vector), [1, 0])
...
def convert_cascade_curve_distribution(
    ...
    if numpoints == 0:
        ...
        if isinstance(cascade_curve, ue.InterpCurveFloat):
            ...
            script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_random_range_float), [1, 0])
            ...
            if target_vector_component is None:
                ...
                script_args  = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_random_range_vector), [1, 0])
                random_range_script = ueFxUtils.create_script_context(script_args)
...
def __create_script_input_random_range(
    ...
    if script_input_type == ue.NiagaraScriptInputType.FLOAT:
        ...
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_random_range_vec2), [1, 0])
        random_range_script = ueFxUtils.create_script_context(script_args)
...
def __create_script_input_lerp(
    ...
    if script_input_type == ue.NiagaraScriptInputType.FLOAT:
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_lerp_float), [1, 0])
        lerp_script = ueFxUtils.create_script_context(script_args)

    elif script_input_type == ue.NiagaraScriptInputType.VEC2:
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_lerp_vec2), [1, 0])
        lerp_script = ueFxUtils.create_script_context(script_args)

    elif script_input_type == ue.NiagaraScriptInputType.VEC3:
        script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_lerp_vector), [1, 0])
        lerp_script = ueFxUtils.create_script_context(script_args)
...
def create_curve_input(curve_di, custom_indexer):
    ...
    if isinstance(curve_di, ue.NiagaraDataInterfaceCurve):
        float_from_curve_script_asset = ue.AssetData(Paths.di_float_from_curve)
        ...
        vec2_from_curve_script_asset = ue.AssetData(Paths.di_vec2_from_curve)
        ...
        vector_from_curve_script_asset = ue.AssetData(Paths.di_vector_from_curve)
...
def expand_value_width(value_input, target_type_width):
    ...
    if value_input.input_type == ue.NiagaraScriptInputType.FLOAT:
        if target_type_width == ue.NiagaraScriptInputType.FLOAT:
            ...
            script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_vec2_from_float), [1, 0])
            ...
            script_args = ue.CreateScriptContextArgs(ue.AssetData(Paths.di_vector_from_float), [1, 0])
