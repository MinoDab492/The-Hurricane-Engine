# -*- coding: utf-8 -*-
"""
Package 'models' contains modules related to objective functions, optimizations, and network architectures.
...
def find_model_using_name(model_name):
    """Import the module "training/models/[model_name]_model.py".

    In the file, the class called DatasetNameModel() will
    be instantiated. It has to be a subclass of BaseModel,
    and it is case-insensitive.
    """
    model_filename = "mldeformer.training." + "models." + model_name + "_model"
